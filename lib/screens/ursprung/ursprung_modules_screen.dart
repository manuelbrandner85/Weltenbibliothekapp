...
/// 🌀 URSPRUNG Modules Screen — Placeholder
class UrsprungModulesScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.school_outlined, size: 64, color: _cyan.withValues(alpha: 0.4)),

...
class VorhangChatTab extends StatefulWidget {
  const VorhangChatTab({super.key});

  @override
  State<VorhangChatTab> createState() => _VorhangChatTabState();
}

class _VorhangChatTabState extends State<VorhangChatTab> {
  static const _gold = Color(0xFFC9A84C);
  static const _bg = Color(0xFF000000);
  static const _surface = Color(0xFF0D0B00);
  static const _surfaceCard = Color(0xFF1A1500);

  static const _rooms = [
    ('vorhang-allgemein', 'Allgemein'),
    ('vorhang-psychologie', 'Dunkle Psychologie'),
    ('vorhang-elite', 'Elite-Strategien'),
  ];

  String _roomId = 'vorhang-allgemein';

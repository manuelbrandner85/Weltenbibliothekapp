...
class _IntroImageScreenState extends State<IntroImageScreen>
  ...
  Future<void> _preloadImage() async {
    try {
      const image = AssetImage('assets/images/intro_weltenbibliothek.webp');
  ...
  Future<void> _navigateToApp() async {
    ...
    try {
      ...
      debugPrint(
          '🎬 IntroImageScreen: Navigiere zu ${hasSeenOnboarding ? "Portal" : "Onboarding"}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        onTap: () {
          debugPrint(
              '🎬 IntroImageScreen: User tap detected, navigating immediately...');
          _navigateToApp();
        },
        child: Stack(
          children: [

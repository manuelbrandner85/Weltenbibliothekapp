...
class BackendHealthMonitorScreen extends StatefulWidget {
  ...
  @override
  State<BackendHealthMonitorScreen> createState() =>
      _BackendHealthMonitorScreenState();
}

class _BackendHealthMonitorScreenState
    extends State<BackendHealthMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    final healthyCount =
        _healthStatuses.values.where((s) => s.isHealthy).length;
          ...
          ? Center(
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(
                    context.wb.palette(WBWorld.neutral).primary),
              ),
            )
          : Stack(
              children: [

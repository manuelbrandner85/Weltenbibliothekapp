...
class MuckRockCard extends StatelessWidget {
  final List<MuckRockFoia> items;
  final bool loading;
  const MuckRockCard({super.key, required this.items, required this.loading});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.description_rounded, color: _accent, size: 18),
  ...
  Widget _buildItem(MuckRockFoia f) {
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Icon(f.hasDocuments ? Icons.folder_rounded : Icons.folder_outlined, color: _accent, size: 15),
              const SizedBox(width: 8),

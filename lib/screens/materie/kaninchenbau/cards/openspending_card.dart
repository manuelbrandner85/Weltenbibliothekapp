  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.savings, color: _accent, size: 18),
        ...
        if (loading)
          ...
          Padding(
              padding: const EdgeInsets.all(20),
              child: Text('Keine Haushaltsdatensätze zum Thema gefunden.',
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child:
            ...
            Row(children: [
              const Icon(Icons.pie_chart, color: _accent, size: 15),
              const SizedBox(width: 8),
              Expanded(
                  child: Text(e.title,
            ...
            Wrap(spacing: 6, runSpacing: 4, children: [
              ...
              if (e.amount > 0)
                Container(
                    ...
                    child: Text('${e.amount.toStringAsFixed(0)} ${e.currency}',
                        style: const TextStyle(
                            color: _accent,
                            fontSize: 10,

  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.payments, color: _accent, size: 18),
        ...
        if (loading)
          ...
          Padding(
              padding: const EdgeInsets.all(20),
              child: Text(
                  'Keine OpenSecrets-Profile verfügbar (API-Key nötig).',
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(children: [
            const Icon(Icons.business_center, color: _accent, size: 15),
            const SizedBox(width: 8),
            Expanded(
            ...
            const Icon(Icons.open_in_new, color: _accent, size: 12),
          ]),
        ),
      ),
    );

    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (loading)
          ...
          Padding(padding: const EdgeInsets.all(20), child: Text('Keine LittleSis-Einträge zum Thema gefunden.', style: TextStyle(color: Colors.white.withValues(alpha: 0.4))))
        else
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              if (e.type.isNotEmpty)
                Text(e.type, style: TextStyle(color: Colors.white.withValues(alpha: 0.4), fontSize: 10)),
            ]),
            if (e.summary.isNotEmpty) ...[
              const SizedBox(height: 4),
              Text(e.summary, style: TextStyle(color: Colors.white.withValues(alpha: 0.55), fontSize: 11, height: 1.4), maxLines: 3, overflow: TextOverflow.ellipsis),
            ],
          ]),
        ),
      ),

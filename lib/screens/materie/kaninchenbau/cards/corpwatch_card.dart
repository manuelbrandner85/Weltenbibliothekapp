  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.report_problem, color: _accent, size: 18),
        ...
        if (loading)
          ...
          Padding(
              padding: const EdgeInsets.all(20),
              child: Text('Keine Unternehmens-Skandale zum Thema gefunden.',
          ...
          child:
            ...
            Wrap(spacing: 6, runSpacing: 4, children: [
              ...
              if (a.date.isNotEmpty)
                Text(a.date.length > 10 ? a.date.substring(0, 10) : a.date,
                    style: TextStyle(
                        color: Colors.white.withValues(alpha: 0.4),
                        fontSize: 10)),
              if (a.tone != 0)
                Text('Tonalität ${a.tone.toStringAsFixed(1)}',
                    style: TextStyle(
                        color: a.tone < 0
                            ? Colors.redAccent

...
class _AlternativeHealingScreenState extends State<AlternativeHealingScreen>
  ...
  String _pubmedQuery = 'alternative medicine herbal';
  final _queryCtrl = TextEditingController(text: 'alternative medicine herbal');
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.science, color: Colors.teal),

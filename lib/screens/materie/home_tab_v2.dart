...
/// MATERIE HOME DASHBOARD V2 - PREMIUM EDITION
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: PremiumSectionHeader(
              ...
              onActionTap: () {
                Navigator.pushNamed(context, '/materie/research');
              },
            ),
          ),
    ...
    return GridView.count(
      ...
      children: [
        PremiumStatCard(
          ...
          gradient: PremiumDesignSystem.materieGradient,
          onTap: () {
            _statsService.trackArticleRead();
            Navigator.pushNamed(context, '/materie/research');
          },
        ),
        PremiumStatCard(
          ...
          onTap: () {
            _statsService.trackResearchSession();
            Navigator.pushNamed(context, '/materie/research');
          },
        ),
        PremiumStatCard(
          ...
          onTap: () {
            _statsService.trackBookmarkAdded();
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('🔖 Lesezeichen gespeichert'), duration: Duration(seconds: 1)),
            );
          },
        ),
        PremiumStatCard(
          ...
          onTap: () {
            _statsService.trackContentShared();
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('📤 Inhalt geteilt'), duration: Duration(seconds: 1)),
            );
          },
        ),
      ],

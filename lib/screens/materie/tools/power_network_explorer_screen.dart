...
class PowerNetworkExplorerScreen extends StatefulWidget {
  ...
  @override
  State<PowerNetworkExplorerScreen> createState() =>
      _PowerNetworkExplorerScreenState();
}
...
class _PowerNetworkExplorerScreenState extends State<PowerNetworkExplorerScreen>
  ...
  Widget _detailContent(PowerNetworkHit h, ScrollController scroll) {
    final props =
        (h.raw['properties'] as Map?)?.cast<String, dynamic>() ?? const {};
    ...
    return Center(
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(height: 4),
          const Text(
              'Alle Treffer aus OpenSanctions + 6 Leak-Datenbanken parallel',
              style: TextStyle(
                  color: Colors.white38,
                  fontSize: 12,
                  fontStyle: FontStyle.italic),
              ...
              children: ['Putin', 'BlackRock', 'Saudi-Arabien', 'Klaus Schwab']
                  .map((s) => OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side:
                              BorderSide(color: _accent.withValues(alpha: 0.3)),
            ...
            child:
              ...
              if (h.tags.isNotEmpty) ...[
                ...
                Wrap(
                    ...
                    runSpacing: 4,
                    children:
                        h.tags.take(4).map((t) => _chip(t, _primary)).toList()),
              ],
              const SizedBox(height: 4),
              Text(h.sourceLabel,
                  style: TextStyle(

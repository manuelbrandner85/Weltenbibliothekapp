...
class _GeoAnalysisToolState extends State<GeoAnalysisTool> {
  ...
  Widget build(BuildContext context) {
    ...
    final wikipedia =
        (_result?['wikipedia'] as List?)?.cast<Map<String, dynamic>>() ?? [];
        ...
        child:
          ...
          Container(
            ...
            child:
              ...
              const Text('Ortsname oder Koordinaten',
                  ...
                  if (lat != null && lon != null) ...[
                    ...
                    OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side:
                            BorderSide(color: _kAccent.withValues(alpha: 0.4)),
                      ),
                    ),
                  ],
                ])),
                            ...
                            Expanded(
                                child: Column(
                                  ...
                                  if (article['distance'] != null)
                                    Text('${article['distance']} m entfernt',
                                        style: const TextStyle(

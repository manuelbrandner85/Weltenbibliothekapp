...
class _CryptoTrackerToolState extends State<CryptoTrackerTool> {
  ...
  bool _isBtc(String a) =>
      RegExp(r'^[13][a-km-zA-HJ-NP-Z1-9]{25,34}$').hasMatch(a) ||
  ...
  Widget build(BuildContext context) {
    ...
    final txs =
        (_result?['transactions'] as List?)?.cast<Map<String, dynamic>>() ?? [];
          ...
          _card(Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            TextField(
              ...
              style: const TextStyle(
                  color: _kText, fontSize: 13, fontFamily: 'monospace'),
            ...
            const Text('BTC: beginnt mit 1, 3 oder bc1  •  ETH: beginnt mit 0x',
            ...
            _card(
              ...
              Row(children: [
                Icon(Icons.account_balance_wallet_rounded,
                    color: coinColor, size: 18),
                const SizedBox(width: 8),
                Text('Wallet-Übersicht',
                    style: TextStyle(
                        color: coinColor,
                        fontWeight: FontWeight.bold,
                        fontSize: 14)),
              ...
              if (_result!['coin'] != null)
                _row('Coin', _result!['coin'].toString()),
              if (_result!['balance'] != null)
                _row('Guthaben', _result!['balance'].toString()),
              if (_result!['balanceUsd'] != null)
                _row('≈ USD', _result!['balanceUsd'].toString()),
              if (_result!['txCount'] != null)
                _row('Transaktionen', _result!['txCount'].toString()),
              if (_result!['firstSeen'] != null)
                _row('Erste Transaktion', _result!['firstSeen'].toString()),
              if (_result!['lastSeen'] != null)
                _row('Letzte Transaktion', _result!['lastSeen'].toString()),
            ])),
            if (txs.isNotEmpty)
              _card(Column(

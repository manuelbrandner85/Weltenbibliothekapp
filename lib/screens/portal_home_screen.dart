...
''';
  ...
  // CINEMA-MODE v6: Daily featured card - rotates per day, no network needed.
  Widget _buildDailyFeatureCard() {
    const features = [
      ['MATERIE', '🔵', 'OSINT-Recherche', 'Quellen hinter den Nachrichten'],
      [
        'ENERGIE',
        '🟣',
        'Chakra-Balance',
      ...
      ['VORHANG', '🟡', 'Symbol-Decoder', 'Geheime Bedeutungen entschluesseln'],
      [
        'URSPRUNG',
        '🟢',
        'Bewusstseins-Atlas',
    ...
    final now = DateTime.now();
    final dayOfYear = now.difference(DateTime(now.year, 1, 1)).inDays;
    final idx = dayOfYear % features.length;
      ...
      child: GestureDetector(
        onTap: () {
          ...
          switch (world) {
            ...
            case 'ENERGIE':
              _navigateWithCinematicTransition(const EnergieWorldWrapper());
            case 'VORHANG':
              _navigateWithCinematicTransition(const VorhangWorldWrapper());
            case 'URSPRUNG':
              _navigateWithCinematicTransition(const UrsprungWorldWrapper());
          }
        },
        child: Container(
          padding: const EdgeInsets.all(14),

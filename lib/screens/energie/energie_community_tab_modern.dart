...
/// - `true` (via [EnergiePostsScreen] vom Home-Screen): zeigt den
...
class EnergieCommunityTabModern extends StatefulWidget {
  ...
  State<EnergieCommunityTabModern> createState() =>
      _EnergieCommunityTabModernState();
}

/// Eigenständiger Beiträge-Feed-Screen für die ENERGIE-Welt.
///
/// Dünner Wrapper, der den Community-Tab im Posts-Modus öffnet. Wird vom
/// Home-Screen über einen "Beiträge"-Eintrag aufgerufen.
class EnergiePostsScreen extends StatelessWidget {
  const EnergiePostsScreen({super.key});

  @override
  Widget build(BuildContext context) =>
      const EnergieCommunityTabModern(postsOnly: true);
}
...
class _EnergieCommunityTabModernState extends State<EnergieCommunityTabModern>
  ...
  String _selectedView =
      'alle'; // 'alle', 'trending', 'fotos', 'diskussion', 'gespeichert'
  ...
  Widget build(BuildContext context) {
    ...
    // [EnergiePostsScreen] (postsOnly=true) vom Home-Screen.
    if (!widget.postsOnly) {
      return const EnergieLiveChatScreen();
    }
          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: _buildSectionTitle('✨ Neueste Beiträge',
                  subtitle: 'Spiritueller Austausch'),
            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              Text(
                                  '${_posts.length} Beiträge · Welt der ENERGIE',
  ...
  Widget _buildStatBanner() {
    final stats = [
      ...
      _CommStat(
          ...
          label: 'Komm.',
          value: _posts.fold(0, (s, p) => s + p.comments),
          color: _kTeal),
      _CommStat(
      ...
      _CommStat(
          ...
          label: 'Geteilt',
          value: _posts.fold(0, (s, p) => s + (p.shares ?? 0)),
          color: _kGold),
    ];
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: RadialGradient(
                      colors: [
                        _kPurple.withValues(alpha: 0.5),
                        _kPurpleD.withValues(alpha: 0.2)
                      ],
                    ),
                    shape: BoxShape.circle,
                    border: Border.all(
                        color: _kPurpleL.withValues(alpha: 0.35), width: 1.5),
                    boxShadow: [
                      BoxShadow(
                          color: _kPurple.withValues(alpha: 0.3), blurRadius: 8)
                    ],
                  ),
                  child: Center(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                  top: BorderSide(color: _kPurple.withValues(alpha: 0.12))),
            ),
            padding: const EdgeInsets.symmetric(vertical: 6, horizontal: 14),
            child: PostActionsRow(
                post: post, accentColor: _kPurple, onPostUpdated: _loadData),
          ),
        ],
      ),
    );
  ...
  Widget _buildHeroPost(CommunityPost post) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            _kPurpleD.withValues(alpha: 0.6),
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            Text('${post.likes}',
                style: TextStyle(
                    color: _kPink, fontSize: 12, fontWeight: FontWeight.bold)),
            ...
            child: Column(children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: _kPurple.withValues(alpha: 0.4), blurRadius: 8)
                  ],
                ),
                child: Padding(
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isActive
                ? [
                    BoxShadow(
                        color: _kGreen.withValues(alpha: 0.6), blurRadius: 6)
                  ]
                : null,
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title:
                    const Text('Melden', style: TextStyle(color: Colors.white)),
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
              ...
              ListTile(
                ...
                title: const Text('Autor blockieren',
                    style: TextStyle(color: Colors.white)),
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
      ...
      child: Row(children: [
        ...
        Container(
          ...
          child: const Text('Alle →',
              style: TextStyle(
                  color: _kPurpleL, fontSize: 10, fontWeight: FontWeight.w600)),
        ),
      ]),
    );
  }

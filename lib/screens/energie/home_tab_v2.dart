...
import 'crystal_library_screen.dart';

/// ENERGIE HOME DASHBOARD V2 - PREMIUM EDITION
            ...
            child: PremiumSectionHeader(
              ...
              onActionTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const CrystalLibraryScreen(),
                  ),
                );
              },
            ),
              ...
              child: PremiumSectionHeader(
                ...
                onActionTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('📜 Alle Aktivitäten laden...'), duration: Duration(seconds: 1)),
                  );
                },
              ),
            ),
    ...
    return GridView.count(
      ...
      children: [
        PremiumStatCard(
          ...
          gradient: PremiumDesignSystem.energieGradient,
          onTap: () {
            _statsService.trackCrystalViewed();
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CrystalLibraryScreen(),
        ...
        PremiumStatCard(
          ...
          onTap: () {
            _statsService.trackTarotReading();
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('⭐ Tarot-Lesung erstellt'), duration: Duration(seconds: 1)),
            );
          },
        ),
        PremiumStatCard(
          ...
          onTap: () {
            _statsService.trackMeditationSession(duration: _meditationMinutes, type: 'dashboard');
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('🧘 Meditation gestartet'), duration: Duration(seconds: 1)),
            );
          },
        ),
        PremiumStatCard(
          ...
          onTap: () {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('⚡ Energie-Details: $_energyLevel%'), duration: const Duration(seconds: 2)),
            );
          },
        ),
      ],

...
class _NumerologyCalculatorScreenState extends State<NumerologyCalculatorScreen>
  ...
  String _getPersonalityNumberText(String name, int number) {
    switch (number) {
      ...
      case 8:
        return '$name, dein äußeres Auftreten ist machtvoll, kompetent und erfolgsorientiert. Menschen sehen dich als starke Persönlichkeit mit natürlicher Autorität. Du strahlst Erfolg aus.';
      case 9:

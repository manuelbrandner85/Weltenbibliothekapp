...
import '../../services/energie_knowledge_service.dart';
import '../../services/energie_book_service.dart';

/// Wissen-Tab für ENERGIE-Welt
class EnergieWissenTab extends StatefulWidget {
  const EnergieWissenTab({super.key});

  @override
  State<EnergieWissenTab> createState() => _EnergieWissenTabState();
}

class _EnergieWissenTabState extends State<EnergieWissenTab> {
  final _knowledgeService = EnergieKnowledgeService();
  final _bookService = EnergieBookService();
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.auto_stories, color: Color(0xFF9C27B0), size: 28),
          ),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    const Icon(Icons.sort, color: Color(0xFF9C27B0), size: 16),
  ...
  Widget _buildSortOption(String label, String value, IconData icon) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, color: isSelected ? const Color(0xFF9C27B0) : Colors.white60, size: 20),
            const SizedBox(width: 12),
            Text(
              label,
              style: TextStyle(
            ...
            const Spacer(),
            if (isSelected)
              const Icon(Icons.check, color: Color(0xFF9C27B0), size: 20),
          ],
        ),
      ),
    );
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  _buildAdvancedChip('Meditation', _selectedCategory == KnowledgeCategory.meditation, () {
                    setState(() => _selectedCategory = KnowledgeCategory.meditation);
                    _applyFilters();
                  }),
                  const SizedBox(width: 8),
                  _buildAdvancedChip('Chakren', _selectedCategory == KnowledgeCategory.chakra, () {
                    setState(() => _selectedCategory = KnowledgeCategory.chakra);
                    _applyFilters();
                  }),
                  const SizedBox(width: 8),
                  _buildAdvancedChip('Astrologie', _selectedCategory == KnowledgeCategory.astrology, () {
                    setState(() => _selectedCategory = KnowledgeCategory.astrology);
                    _applyFilters();
                  }),
                  const SizedBox(width: 8),
                  _buildAdvancedChip('Numerologie', _selectedCategory == KnowledgeCategory.numerology, () {
                    setState(() => _selectedCategory = KnowledgeCategory.numerology);
                    _applyFilters();
                  }),
                ],
              ),

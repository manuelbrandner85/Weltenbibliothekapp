...
class EnergieHomeTabV3 extends StatefulWidget {
  const EnergieHomeTabV3({super.key});

  @override
  State<EnergieHomeTabV3> createState() => _EnergieHomeTabV3State();
}

class _EnergieHomeTabV3State extends State<EnergieHomeTabV3>
  ...
  Widget _buildStatsGrid() {
    final stats = [
      {'label': 'Meditation', 'value': _totalArticles, 'icon': Icons.article, 'color': const Color(0xFF9B59B6)},
      {'label': 'Chakren', 'value': _researchSessions, 'icon': Icons.auto_awesome, 'color': const Color(0xFF6C5CE7)},
      {'label': 'Kristalle', 'value': _bookmarkedTopics, 'icon': Icons.diamond, 'color': const Color(0xFFA29BFE)},
      {'label': 'Energie', 'value': _sharedFindings, 'icon': Icons.flash_on, 'color': const Color(0xFFE056FD)},
    ];
  ...
  List<Color> _getTrendingColors(int index) {
    final colorSets = [
      ...
      [const Color(0xFF6C5CE7), const Color(0xFF5F4FCD)],
      [const Color(0xFFA29BFE), const Color(0xFF8A7FEE)],
      [const Color(0xFFE056FD), const Color(0xFFB74AF0)],
      [const Color(0xFF9B59B6), const Color(0xFF8E44AD)],

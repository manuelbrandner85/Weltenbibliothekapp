...
class _AlternativeHealingScreenState extends State<AlternativeHealingScreen>
  ...
  final _queryCtrl =
      TextEditingController(text: 'herbal medicine plant healing');
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: ListTile(
            leading:
                const Icon(Icons.healing, color: Color(0xFF7C4DFF), size: 32),
            title: Text(
            ...
            children: [
              ...
              if (study.authors.isNotEmpty)
                Text(
                  study.authors.join(', '),
                  style:
                      const TextStyle(color: Color(0xFF7C4DFF), fontSize: 12),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ),

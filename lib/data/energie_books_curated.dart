...
''',
    ...
    type: 'book',
    tags: ['tolle', 'praesenz', 'achtsamkeit', 'klassiker', 'einstieg', 'jetzt'],
...
''',
    category: 'Yoga',
    type: 'book',
    tags: ['yogananda', 'yoga', 'mystik', 'klassiker', 'indien', 'kriya', 'meister'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['hay', 'affirmationen', 'psychosomatik', 'klassiker', 'selbstliebe', 'heilung'],
    createdAt: DateTime.now(),
...
''',
    category: 'Kristalle',
    type: 'book',
    tags: ['hall', 'kristalle', 'steinheilkunde', 'handbuch', 'mineralogie', 'energetik'],
    createdAt: DateTime.now(),
...
''',
    category: 'Chakren',
    type: 'book',
    tags: ['myss', 'chakren', 'kabbala', 'energetik', 'psychosomatik', 'tiefe', 'synthese'],
    createdAt: DateTime.now(),
...
''',
    category: 'Bewusstsein',
    type: 'book',
    tags: ['hawkins', 'bewusstseinsstufen', 'kinesiologie', 'kalibrierung', 'macht', 'evolution'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['weiss', 'reinkarnation', 'regression', 'hypnose', 'wissenschaft', 'mut'],
    createdAt: DateTime.now(),
...
''',
    category: 'Energetische Heilung',
    type: 'book',
    tags: ['brennan', 'aura', 'energetik', 'lehrbuch', 'heilung', 'physik', 'nasa'],
    createdAt: DateTime.now(),
...
''',
    category: 'Taoismus',
    type: 'book',
    tags: ['hoff', 'taoismus', 'wu-wei', 'pooh', 'einstieg', 'lao-tse', 'heiter'],
    createdAt: DateTime.now(),
...
''',
    category: 'Bewusstsein',
    type: 'book',
    tags: ['walsch', 'dialog', 'gott', 'channeling', 'theologie', 'neu', 'mystik'],
    createdAt: DateTime.now(),
...
''',
    category: 'Yoga',
    type: 'book',
    tags: ['grill', 'atem', 'pranayama', 'anthroposophie', 'mystik', 'deutsch', 'subtilitaet'],
    createdAt: DateTime.now(),
    imageUrl: null,
    author: 'Heinz Grill',
    yearPublished: 2005,
...
''',
    ...
    type: 'book',
    tags: ['padmasambhava', 'tibet', 'tod', 'bardo', 'buddhismus', 'klassiker', 'mystik'],
    createdAt: DateTime.now(),
...
''',
    category: 'Mystik',
    type: 'book',
    tags: ['gruen', 'christlich', 'benediktiner', 'alltag', 'deutsch', 'praxis', 'mystik'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['cashford', 'mond', 'mythologie', 'goettin', 'zyklus', 'kulturgeschichte', 'jung'],
    createdAt: DateTime.now(),
...
''',
    category: 'Chakren',
    type: 'book',
    tags: ['judith', 'chakren', 'lehrbuch', 'yoga', 'standardwerk', 'psychologie', 'energetik'],
    createdAt: DateTime.now(),

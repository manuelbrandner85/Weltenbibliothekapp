...
final List<EnergieLocationDetail> extraEnergieLocations = [
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''6.638 m hoher Berg im Transhimalaya. Heilig für Buddhisten (Demchok), Hindus (Shiva), Jains (Adinatha) und die Bön-Religion. Bis heute UNBESTIEGEN — Bergsteiger respektieren die religiöse Bedeutung.
...
Wissenschaftlich kontroverse Berichte: Beschleunigtes Haar- und Nagelwachstum bei Pilgern, abrupte Wettermuster, magnetische Anomalien.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''3.776 m, Japans höchster Berg, perfekt symmetrischer Stratovulkan. Im Shintoismus Sitz der Göttin Sengen-Sama. UNESCO-Welterbe (2013) als "heiliger Ort und Inspirationsquelle".
...
Jährlich 300.000+ Pilger besteigen den Berg in der kurzen Saison (Juli-August). Der Krater am Gipfel = "Tor zur anderen Welt" in der Tradition. Erste belegte Besteigung: 663 n.Chr. durch einen Mönch.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''4 anerkannte Hauptvortexe: Bell Rock, Cathedral Rock, Boynton Canyon, Airport Mesa. Roter Sandstein mit hohem Eisenoxid-Gehalt — messbare elektromagnetische Anomalien.
...
Pete Sanders (MIT-Physiker) untersuchte 1995 die geomagnetischen Felder und fand reproduzierbare Abweichungen. Hopi-Tradition: Sedona ist Tor zur "Vierten Welt". Über 4 Millionen Besucher jährlich — größtes spirituelles Reiseziel Nordamerikas.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''4.322 m Stratovulkan, heiliger Berg für die Wintu, Karuk, Modoc und Shasta. In der Neuzeit (seit 1880er) mit Theosophie verknüpft: "Lemurianer" leben angeblich im Inneren. Guy Ballard ("I AM Activity") behauptete 1930 Begegnungen mit Saint Germain hier.
...
Wissenschaftlich: aktiver Vulkan, letzte Eruption ~1786. Linsenwolken über dem Gipfel sind häufig — oft als UFO-Sichtungen interpretiert.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''348 m hoher Sandstein-Inselberg im Roten Zentrum Australiens. Heilig für die Anangu-Aborigines seit mindestens 30.000 Jahren. Songlines (Traumzeit-Pfade) der Schöpfungswesen kreuzen sich hier.
...
Seit 26. Oktober 2019 ist das Besteigen verboten — die Anangu hatten jahrzehntelang darum gebeten. UNESCO-Welterbe doppelt: Natur + Kultur. Geologisch faszinierend: das Sichtbare ist nur ~10% des Felsens — der Rest liegt unter der Wüste.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''162,6 Hektar — größte religiöse Anlage weltweit. Erbaut im 12. Jh. unter Suryavarman II als Hindu-Tempel für Vishnu, später buddhistisch genutzt. Bezeichnet das hinduistische Universum: zentrales Plateau = Mount Meru, äußere Mauer = Bergketten am Weltrand.
...
Astronomische Ausrichtung: Westeingang exakt zur Tagundnachtgleiche. Wissenschaftliche Studien (Graham Hancock) zeigen Sterne-Korrelation zur Konstellation Draco um 10.500 v.Chr.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''9. Jh. erbaut, dann ~400 Jahre vergessen unter Asche und Dschungel. 1814 von Raffles wiederentdeckt. 504 Buddha-Statuen, 72 perforierte Stupas am Hauptdach. 3 Ebenen = die drei buddhistischen Sphären (Kamadhatu, Rupadhatu, Arupadhatu).
...
Pilger umrunden den Komplex im Uhrzeigersinn, immer höher steigend — der Pfad zur Erleuchtung als gebaute Meditation. UNESCO-Welterbe seit 1991.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Über 2.000 Jahre lang erweitert (ca. 2055 v.Chr. bis 30 n.Chr.). 30+ Pharaonen ließen daran bauen. Säulenhalle mit 134 Säulen, die größten 21 m hoch und 5 m im Durchmesser.
...
Ausrichtung des Haupttempels: Sommer-Sonnenwende-Sonnenaufgang. Akustische Eigenschaften: Geräusche der heilen Steine sind dokumentiert. Heilige Geometrie und Maßeinheiten passen exakt zur Großen Pyramide.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Höhepunkt 200-900 n.Chr. Pyramiden bis 70 m hoch, Tempel I (Tempel des Riesen-Jaguar). Astronomisch präzise: Pyramiden-Spitze von Tempel IV markiert Sonnenwende-Punkte exakt.
...
Mysteriöse Geschichte: Tikal kollabierte um 900 n.Chr. ohne klare Ursache. Theorien: Klimawandel, Krieg, Epidemie. Heute UNESCO-Welterbe im Regenwald.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''3.200 v.Chr. — älter als Stonehenge (3.000 v.Chr.) und die Cheops-Pyramide (2.560 v.Chr.). Hügelgrab mit 19 m langem Korridor zum zentralen Raum.
...
Sensationelle astronomische Funktion: Bei der Wintersonnenwende (21. Dez.) dringt das Sonnenlicht durch ein präzises "Roof-Box"-Fenster über dem Eingang und erleuchtet 17 Minuten lang den hintersten Raum. Die Spiral-Reliefs (Triskele) sind ikonisch.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''13 Sandsteinfelsen im Teutoburger Wald, bis 40 m hoch. In Stein gehauenes Kreuzabnahme-Relief (~1130 n.Chr.). Höhlenkammer mit kreisrundem Loch — am 21. Juni zeigt die aufgehende Sonne durch das Loch.
...
Wilhelm Teudt postulierte 1929 ein "Heiliges Linien-System" (Heilige Linien) durch Norddeutschland mit den Externsteinen als Knotenpunkt. Heute hochfrequentierter Kraftort für deutsche Esoterik-Tourismus.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''158 m hoher Hügel mit dem Turm der Saint Michael-Kirche (14. Jh.). Mit dem Avalon-Mythos (König Artus) verknüpft. Christliche Tradition: Joseph von Arimathäa soll hier 30 n.Chr. den Heiligen Gral begraben haben.
...
Der Hügel mit seinem Spiral-Pfad gilt als der "Heart Chakra der Erde" in der Neuzeit-Esoterik. Quellen am Fuß: Chalice Well (eisenhaltig-rot) und White Spring (kalkhaltig-weiß) — alchemistische Polarität.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Vor 4.500 Jahren erbaut, etwa zeitgleich mit Stonehenge. 332 m Durchmesser des äußeren Rings — 14× größer als Stonehenge. Drei Steinkreise innerhalb eines Henges mit Graben (jetzt 9 m tief).
...
Avebury ist Teil eines größeren Komplexes mit Silbury Hill (38 m hoher künstlicher Hügel) und West Kennet Long Barrow. UNESCO-Welterbe gemeinsam mit Stonehenge.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''2000 entdeckt, 300 m tief unter der Wüste Chihuahua. Selenit-Kristalle bis 12 m lang und 1 m Durchmesser, schätzungsweise 500.000 Jahre alt. Wachstum war nur möglich, weil die Höhle exakt 58°C und 100% Luftfeuchtigkeit hatte — das gilt als "Kristall-Inkubator".
...
Forscher konnten nur mit Spezial-Schutzanzügen 30 Minuten am Stück hinein. 2017 wieder geflutet — die Bergwerk-Pumpen wurden abgeschaltet, das Wasser kehrt zurück. Die Kristalle wachsen jetzt wieder. Die Höhle ist faktisch verloren für die Forschung.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''>676 km kartierte Gänge — fünfmal länger als das zweitgrößte System der Welt. Indigene Nutzung dokumentiert bis 4.000 Jahre zurück (Mumien gefunden 1813). UNESCO-Welterbe seit 1981.
...
Karst-Höhlenkomplex mit besonderem Mikroklima. Untergrund-Atmosphäre wirkt nachweislich beruhigend (negativ ionisierte Luft).''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''3.724 m, Neuseelands höchster Berg. Heilig für die Ngāi Tahu-Maori als versteinerter Vorfahre. 1998 in der Treaty of Waitangi-Reform offiziell auch unter Maori-Namen anerkannt.
...
Die Edmund-Hillary-Gedenkstätte erinnert an die Mount-Everest-Vorbereitung: Hillary trainierte hier. Aoraki Mackenzie Dark Sky Reserve — eines der dunkelsten Himmelsareale der Erde, optimal für Sternenbeobachtung.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''6.961 m — höchster Gipfel der Anden und außerhalb Asiens. 1985 Fund einer Inka-Kindermumie auf 5.300 m — Beleg für Höhen-Ritualstätten der Inka. "Aconcagua" bedeutet möglicherweise "Steinwächter" (Quechua).
...
Wettergottheit-Sitz in der Inka-Kosmologie. Gilt heute als kraftvoller Bewusstseins-Punkt für die spirituelle Praxis "Munay-Ki" der Q\'ero-Schamanen.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Einer der aktivsten Vulkane der Welt, fast durchgehend aktiv seit 1983. Im hawaiianischen Glauben ist hier Pele zu Hause — die Göttin der Vulkane, der Feuer und des Schaffens.
...
Lavaformen werden als Botschaften gedeutet. Touristen, die Lavasteine mitnehmen, bekommen laut Tradition Unglück ("Pele\'s curse") — die Volcanoes National Park-Verwaltung erhält jährlich Pakete mit zurückgeschickten Steinen.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''1858: Die 14-jährige Bernadette Soubirous hatte 18 Marienerscheinungen in der Grotte Massabielle. Quelle entsprang dort, wo die Jungfrau hinwies — heute kommen 6 Mio. Pilger jährlich für Heilung.
...
70 Heilungen offiziell von der katholischen Kirche als "wunderbar" anerkannt (von ~7.000 ungeklärten Spontanremissionen). Lourdes Medical Bureau prüft seit 1883 alle Heilungsberichte wissenschaftlich.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: 'Harmandir Sahib (1604 gebaut), umgeben vom heiligen "Pool der Unsterblichkeit" (Amrit Sarovar). Tag und Nacht offen für alle Religionen — 100.000 Menschen täglich essen kostenlos im Langar (Gemeinschaftsküche).\n\nGoldene Kuppel: 750 kg reines Gold (1830 erneuert). Akustisch: Live-Kirtan (heilige Gesänge) 20 Stunden täglich. Eines der wenigen Heiligtümer mit 4 Eingängen — symbolisiert Offenheit für alle Himmelsrichtungen.',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''20 Klöster auf einer Halbinsel in Griechenland. Autonomes Gebiet — Frauen seit 1.000 Jahren verboten (auch weibliche Tiere, bis auf Hauskatzen für Mäusebekämpfung). Hesychasmus: kontinuierliches Jesus-Gebet als Erleuchtungsweg.
...
Die ältesten Mönche praktizieren das "Herzensgebet" 18+ Stunden täglich. Manche der Klöster behalten Reliquien aus dem 9. Jh. bei. UNESCO-Welterbe.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Spätes 19. Jh. von António Augusto Carvalho Monteiro entworfen (mit dem Architekten Luigi Manini). Templer- und Freimaurer-Symbolik überall. Der "Initiationsbrunnen" — 27 m tief, mit 9 spiralförmigen Stockwerken — diente esoterischen Einweihungsritualen.
...
Tunnels verbinden den Brunnen mit anderen Symbolik-Orten des Gartens. Sintra selbst gilt seit der Romantik als magischer Ort, in einer "energetischen Kerbe" zwischen Atlantik und Iberischer Hochebene.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''4. Jh. v.Chr. — 1. Jh. n.Chr. Hauptstadt der Nabatäer. In rosa Sandstein gehauen, das berühmte "Schatzhaus" (Al-Khazneh) zeigt die typische Architektur. Astronomische Ausrichtung der Hauptmonumente zur Tagundnachtgleiche.
...
Die Nabatäer kontrollierten die Karawanenrouten und das Wasser — eine Stadt mitten in der Wüste, gespeist durch ausgeklügelte Kanal-Systeme. UNESCO-Welterbe.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''Hier saß Siddhartha Gautama unter dem Bodhi-Baum, als er Erleuchtung erlangte (~528 v.Chr.). Der Mahabodhi-Tempel (3. Jh. v.Chr. begonnen, im 5./6. Jh. n.Chr. ausgebaut) ist das heiligste Zentrum des Buddhismus.
...
Der jetzige Bodhi-Baum ist ein direkter Nachkomme des Originals — Ableger wurden mehrmals durch die Jahrhunderte gerettet. UNESCO-Welterbe. Jährlich 2 Millionen buddhistische Pilger.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''3.700 m Höhe. 7. Jh. erbaut, mehrmals erneuert — heutige Form von Dalai Lama V (17. Jh.). 13 Stockwerke, über 1.000 Räume. UNESCO-Welterbe.
...
Bis 1959 Hauptresidenz des Dalai Lama und Sitz der tibetischen Regierung. Heute Museum unter chinesischer Verwaltung. Pilger umrunden den Komplex bis heute betend.''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''708 n.Chr. von Bischof Aubert gegründet, nach einer Vision des Erzengels Michael. Bei Flut wird der Berg eine Insel, bei Ebbe begehbar — Symbolik für den spirituellen Übergang.
...
Der Mont liegt exakt auf der "Apollo-Michael-Linie" — der berühmtesten europäischen Leyline (St. Michael\'s Mount in England → Hetlin in Cornwall → Mont-Saint-Michel → Sacra di San Michele in Italien → Monte Gargano → Symi-Insel → Stella Maris auf dem Karmel).''',
  ...
  EnergieLocationDetail(
    ...
    detailedInfo: '''11. Jh. errichtet auf dem Monte Pirchiriano (962 m, Piemont). Liegt auf der berühmten "Sword of Michael"-Linie — sieben Michaelsheiligtümer auf einer geraden Linie quer durch Europa.

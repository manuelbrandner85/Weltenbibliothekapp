// 🔯 HEILIGE GEOMETRIE — 12-TAGE-MUSTER
// 12 Sakralformen aus verschiedenen Traditionen. Tägliche Meditationsform.
...
const List<LessonSeriesEntry> sacredGeometry12 = [
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Zwei sich überlappende Kreise. Mandorla. Tor zwischen den Welten. '
        'Vater + Mutter = Kind. Yoni-Form, Christus-Aureole.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Sechseck — die effizienteste Form für maximale Fläche bei minimalem Material. '
        'Bienen, Schneeflocken, Kohlenstoff (Diamant/Graphit).',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Zwei ineinander verflochtene Dreiecke. Eines nach oben (Feuer/männlich/Geist), '
        'eines nach unten (Wasser/weiblich/Materie). Vereinigung.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        '9 Dreiecke (4 Shiva-aufwärts, 5 Shakti-abwärts) bilden 43 kleinere '
        'Dreiecke. Diagramm der gesamten Schöpfung. Tantrisches Meisterwerk.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        '13 Kreise aus der Blume des Lebens, verbunden zu allen 5 Platonischen '
        'Körpern (Tetraeder/Würfel/Oktaeder/Dodekaeder/Ikosaeder).',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Spirale nach Phi (1.618...). Schneckenhäuser, Galaxien, Sonnenblumen, '
        'Fingerabdrücke. Universelles Wachstumsprinzip.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        '"Mer-Ka-Ba" = Licht-Geist-Körper (Hebräisch). 3D-Sternentetraeder. '
        'Ägypt-/Kabbal-Lehre: Lichtfahrzeug der Seele, aktiviert durch Atmung.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Geometrie eines Apfels, eines Magnetfelds, eines Herzfeldes (HeartMath). '
        'Energie fließt durch das Zentrum, zirkuliert außen, zurück durchs Zentrum.',
    reflection:
        'Wo zirkuliert deine Energie gerade in einer geschlossenen, nährenden Schleife?',
  ),
];

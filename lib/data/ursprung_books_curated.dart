...
''',
    ...
    type: 'book',
    tags: ['Lakota', 'Vision', 'Schamanismus', 'Heiliger-Reif', 'Mythologie', 'Trauer'],
...
''',
    ...
    type: 'book',
    tags: ['Sibirien', 'Permakultur', 'Pflanzen', 'Familienlandsitz', 'Naturverbundenheit'],
    createdAt: DateTime.now(),
...
''',
    category: 'Astronomie',
    type: 'book',
    tags: ['Astronomie', 'Kosmologie', 'Wissenschaft', 'Universum', 'Sternenstaub', 'Sagan'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['Phaenomenologie', 'Tiere', 'Koerper', 'Wahrnehmung', 'Oekologie', 'Abram'],
    createdAt: DateTime.now(),
...
''',
    category: 'Tiefenoekologie',
    type: 'book',
    tags: ['Phaenomenologie', 'Schrift', 'Wahrnehmung', 'Animismus', 'Sprache', 'Abram'],
    createdAt: DateTime.now(),
...
''',
    category: 'Indigene-Weisheit',
    type: 'book',
    tags: ['Aboriginal', 'Australien', 'Yarning', 'Country', 'Mustererkennung', 'Yunkaporta'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['Potawatomi', 'Botanik', 'Reziprozitaet', 'Drei-Schwestern', 'Pflanzen', 'Kimmerer'],
    createdAt: DateTime.now(),
...
''',
    category: 'Mythologie',
    type: 'book',
    tags: ['Hopi', 'Pueblo', 'Schoepfungsgeschichte', 'Prophezeiungen', 'Kachina', 'Arizona'],
    createdAt: DateTime.now(),
...
''',
    category: 'Kosmologie',
    type: 'book',
    tags: ['Quantenphysik', 'Mystik', 'Buddhismus', 'Taoismus', 'Bewusstsein', 'Capra'],
    createdAt: DateTime.now(),
...
''',
    category: 'Pflanzenmedizin',
    type: 'book',
    tags: ['Pflanzengeist', 'Heilung', 'Schamanismus', 'Huichol', 'Pflanzenmedizin', 'Cowan'],
    createdAt: DateTime.now(),
...
''',
    ...
    type: 'book',
    tags: ['Castaneda', 'Yaqui', 'Krieger', 'Wahrnehmung', 'Schamanismus', 'Mexiko'],
    createdAt: DateTime.now(),
...
''',
    category: 'Indigene-Weisheit',
    type: 'book',
    tags: ['San', 'Kalahari', 'Buschmaenner', 'Trance-Tanz', 'Suedafrika', 'Mantis'],
    createdAt: DateTime.now(),
    imageUrl: null,
...
''',
    ...
    type: 'book',
    tags: ['Maya', 'Astronomie', 'Praezession', '2012', 'Galaktisches-Zentrum', 'Mesoamerika'],
    createdAt: DateTime.now(),
...
''',
    category: 'Antike-Hochkulturen',
    type: 'book',
    tags: ['Karten', 'Antarktis', 'Piri-Reis', 'Atlantis', 'Hochkulturen', 'Kartographie'],
    createdAt: DateTime.now(),
    imageUrl: null,

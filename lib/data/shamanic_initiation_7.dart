// 🥁 SCHAMANISCHE REISE — 7-TAGE-INITIATION
// Drei-Welten-Modell aus core shamanism (M. Harner). Reise mit Drum-Beat.
...
const List<LessonSeriesEntry> shamanicInitiation7 = [
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'In Trommelreise um ein Krafttier bitten. Es zeigt sich 3x auf demselben Weg — '
        'dann ist es deins. Tier kann zahm oder wild sein.',
    reflection:
  ...
  LessonSeriesEntry(
    ...
    meaning:
        'Trauma fragmentiert die Seele. Schamanische Seelenrückholung: Reise, '
        'um ein vor Jahren abgespaltetes Stück (z.B. inneres Kind) zurückzubringen.',
    reflection:

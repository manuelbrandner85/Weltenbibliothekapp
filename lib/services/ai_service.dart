...
class AIService {
    ...
    try {
      final response = await http
          ...
          .timeout(const Duration(
              seconds: 45)); // Erhöhtes Timeout für Worker Response
  ...
  static Future<List<Map<String, dynamic>>> predictEvents(
  ...
  static Map<String, dynamic> _fallbackPropagandaAnalysis(String text) {
    ...
    return {
      ...
      'alternative_view':
          'Lokale Offline-Analyse - Für genauere Ergebnisse bitte Internet-Verbindung prüfen',
      'warnings': [
        '⚠️ KI-Worker nicht erreichbar',
        'Verwende lokale Basis-Analyse',
        'Für präzisere Ergebnisse Online-Modus nutzen'
      ],
  ...
  static Map<String, dynamic> _fallbackImageAnalysis() {
    return {
      ...
      'warnings': [
        'Das Bildformat wird nicht unterstützt oder die Datei ist beschädigt',
        'Bitte verwenden Sie JPEG oder PNG Formate'
      ],
      'isLocalFallback': true,
      'isRealAI': false,
      'tests': {},

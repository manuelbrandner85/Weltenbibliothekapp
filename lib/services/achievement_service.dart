...
class AchievementService {
  ...
  void _defineAchievements() {
    final achievements = [
      ...
      // ✨ v5.44.4 SPIRIT-TOOL ACHIEVEMENTS
      // Triggern bei SpiritReadingService.save() (siehe _awardXp Pfad).
      Achievement(
        id: 'spirit_first',
        name: 'Spirituelles Erwachen',
        description: 'Nutze dein erstes Spirit-Tool',
        icon: '✨',
        category: AchievementCategory.explorer,
        rarity: AchievementRarity.common,
        xpReward: 15,
      ...
      Achievement(
        id: 'spirit_10',
        name: 'Spirit-Lernender',
        description: 'Speichere 10 Spirit-Readings',
        icon: '🕯️',
        category: AchievementCategory.explorer,
        rarity: AchievementRarity.common,
        xpReward: 50,
      ...
      Achievement(
        id: 'spirit_50',
        name: 'Spirit-Erfahrener',
        description: 'Speichere 50 Spirit-Readings',
        icon: '🔮',
        category: AchievementCategory.explorer,
        rarity: AchievementRarity.uncommon,
        xpReward: 150,
      ...
      Achievement(
        id: 'spirit_100',
        name: 'Spirit-Meister',
        description: 'Speichere 100 Spirit-Readings',
        icon: '🌟',
        category: AchievementCategory.explorer,
        rarity: AchievementRarity.rare,
        xpReward: 400,
      ...
      Achievement(
        id: 'spirit_seven_tools',
        name: 'Sieben-Welten-Wanderer',
        description: 'Nutze 7 verschiedene Spirit-Tools',
        icon: '🧙',
        category: AchievementCategory.explorer,
        rarity: AchievementRarity.rare,
        xpReward: 250,
      ...
      Achievement(
        id: 'spirit_streak_7',
        name: 'Spirit-Routine',
        description: 'Spirit-Tools an 7 aufeinanderfolgenden Tagen',
        icon: '🔥',
        category: AchievementCategory.streak,
        rarity: AchievementRarity.uncommon,
        xpReward: 100,
      ...
      Achievement(
        id: 'spirit_master_diviner',
        name: 'Wahrsager-Meister',
        description: 'Vollende eine Sitzung mit jedem der 14 Spirit-Tools',
        icon: '👑',
        category: AchievementCategory.master,
      ...
      // ── Numerologie-Achievements (Verbesserung 7 + 10) ───────────────
      Achievement(
        id: 'numerology_pdf_first',
        name: 'Seelenportraet',
        description: 'Erstelle dein erstes numerologisches PDF',
        icon: '📜',
      ...
      Achievement(
        id: 'numerology_pdf_share_5',
        name: 'Wissensverbreiter',
        description: 'Teile 5 Seelenportraets',
        icon: '🔗',
        category: AchievementCategory.creator,
        rarity: AchievementRarity.uncommon,
        xpReward: 50,
      ...
      Achievement(
        id: 'numerology_quiz_lehrling',
        name: 'Numerologie-Lehrling',
        description: 'Bestehe das Grundlagen-Quiz (7 von 10)',
        icon: '🥉',
        category: AchievementCategory.knowledge,
        rarity: AchievementRarity.common,
        xpReward: 30,
      ...
      Achievement(
        id: 'numerology_quiz_geselle',
        name: 'Numerologie-Geselle',
        description: 'Bestehe das Fortgeschrittenen-Quiz (7 von 10)',
        icon: '🥈',
        category: AchievementCategory.knowledge,
        rarity: AchievementRarity.uncommon,
        xpReward: 60,
      ...
      Achievement(
        id: 'numerology_quiz_meister',
        name: 'Numerologie-Meister',
        description: 'Bestehe das Experten-Quiz (7 von 10)',
        icon: '🥇',
        category: AchievementCategory.knowledge,
        rarity: AchievementRarity.rare,
        xpReward: 120,
      ...
      Achievement(
        id: 'numerology_quiz_guru',
        name: 'Zahlen-Guru',
        description: 'Beantworte alle 10 Experten-Fragen korrekt',
        icon: '💎',
        category: AchievementCategory.master,
        rarity: AchievementRarity.legendary,
        xpReward: 250,

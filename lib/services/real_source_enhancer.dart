...
class RealSourceEnhancer {
  ...
  static Future<List<Map<String, String>>> findRealTelegramChannels(
      String query) async {
    ...
    if (channels.length < 3) {
      ...
      if (kDebugMode) {
        ...
        for (final ch in knownChannels) {
          debugPrint(
              '   - Original: channel=${ch['channel']}, title=${ch['title']}, description=${ch['description']}');
        }
      }
  ...
  static List<Map<String, String>> _getThemeImages(String query) {
    ...
    if (lowercaseQuery.contains('wikileaks') ||
      ...
      images.addAll([
        {
          'url':
              'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Wikileaks_logo.svg/800px-Wikileaks_logo.svg.png',
          'thumbnail':
              'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Wikileaks_logo.svg/300px-Wikileaks_logo.svg.png',
      ...
      images.addAll([
        {
          ...
          'thumbnail':
              'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Seal_of_the_Central_Intelligence_Agency.svg/300px-Seal_of_the_Central_Intelligence_Agency.svg.png',
          'title': 'CIA Seal',
          'source': 'Wikimedia',
          'type': 'image',
        },
  ...
  static List<Map<String, String>> filterSpecificPages(
  ...
  static String _extractPdfTitle(String url) {
    ...
    final filename =
        uri.pathSegments.isNotEmpty ? uri.pathSegments.last : 'dokument.pdf';
      ...
      channels.addAll([
        {
          ...
          'title': 'WikiLeaks Official',
          'description':
              'Official WikiLeaks Telegram - Alternative news source',
        },
        {

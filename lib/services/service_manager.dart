  ...
  Future<void> initializeCriticalServices() async {
    ...
    try {
      ...
      await _initializeService(
        ...
        critical: true,
        timeout: const Duration(seconds: 10), // 🔧 FIX: Erhöht von 5s auf 10s für langsame Geräte
      );
      ...
      await _initializeService(
        ...
        critical: true,
        timeout: const Duration(seconds: 3), // 🔧 FIX: Erhöht von 1s auf 3s
      );
      ...
      await _initializeService(
        ...
        critical: true,
        timeout: const Duration(seconds: 5), // 🔧 FIX: Erhöht von 2s auf 5s
      );

...
DROP POLICY IF EXISTS "tool_meditation_sessions_select" ON public.tool_meditation_sessions;
CREATE POLICY "tool_meditation_sessions_select" ON tool_meditation_sessions FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_meditation_sessions_insert" ON public.tool_meditation_sessions;
CREATE POLICY "tool_meditation_sessions_insert" ON tool_meditation_sessions FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_meditation_sessions_delete" ON public.tool_meditation_sessions;
...
DROP POLICY IF EXISTS "tool_kristalle_insert" ON public.tool_kristalle;
CREATE POLICY "tool_kristalle_insert" ON tool_kristalle FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_kristalle_delete" ON public.tool_kristalle;
...
DROP POLICY IF EXISTS "tool_geopolitics_events_select" ON public.tool_geopolitics_events;
CREATE POLICY "tool_geopolitics_events_select" ON tool_geopolitics_events FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_geopolitics_events_insert" ON public.tool_geopolitics_events;
CREATE POLICY "tool_geopolitics_events_insert" ON tool_geopolitics_events FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_geopolitics_events_delete" ON public.tool_geopolitics_events;
...
DROP POLICY IF EXISTS "tool_history_events_select" ON public.tool_history_events;
CREATE POLICY "tool_history_events_select" ON tool_history_events FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_history_events_insert" ON public.tool_history_events;
CREATE POLICY "tool_history_events_insert" ON tool_history_events FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_history_events_delete" ON public.tool_history_events;
...
DROP POLICY IF EXISTS "tool_healing_methods_select" ON public.tool_healing_methods;
CREATE POLICY "tool_healing_methods_select" ON tool_healing_methods FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_healing_methods_insert" ON public.tool_healing_methods;
CREATE POLICY "tool_healing_methods_insert" ON tool_healing_methods FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_healing_methods_delete" ON public.tool_healing_methods;
...
DROP POLICY IF EXISTS "tool_network_connections_select" ON public.tool_network_connections;
CREATE POLICY "tool_network_connections_select" ON tool_network_connections FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_network_connections_insert" ON public.tool_network_connections;
CREATE POLICY "tool_network_connections_insert" ON tool_network_connections FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_network_connections_delete" ON public.tool_network_connections;
...
DROP POLICY IF EXISTS "tool_research_documents_select" ON public.tool_research_documents;
CREATE POLICY "tool_research_documents_select" ON tool_research_documents FOR SELECT USING (true);
DROP POLICY IF EXISTS "tool_research_documents_insert" ON public.tool_research_documents;
CREATE POLICY "tool_research_documents_insert" ON tool_research_documents FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "tool_research_documents_delete" ON public.tool_research_documents;

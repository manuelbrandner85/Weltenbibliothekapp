...
-- Buckets upserten — Supabase blockt DELETE auf storage.* (protect_delete Trigger).
-- Existierende Objekte bleiben erhalten, Bucket-Konfig wird aktualisiert.

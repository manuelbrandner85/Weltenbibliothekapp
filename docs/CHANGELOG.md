# 🌍 Weltenbibliothek – CLAUDE.md Archiv (vor Optimierung 2026-05-17)

> **ARCHIV.** Das ist eine 1:1-Kopie der CLAUDE.md, wie sie vor der Schlankheits-
> Optimierung am 2026-05-17 ausgesehen hat. Enthält die vollständige "Erledigt"-
> Liste aller PRs (#28 bis #168, Bundle-Audits, LiveKit-Migration, Update-System,
> Mai-2026 VORHANG-Module), Architektur-Diagramme, Credentials-Tabelle, Shorebird-
> Pinning-Details, Keystore-Regeln, FCM-Setup, Audio/Health-Plugin-Doku und
> Fallstricke. Lebende Regeln stehen in der schlanken `CLAUDE.md` plus den

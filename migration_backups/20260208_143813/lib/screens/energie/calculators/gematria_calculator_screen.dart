          ...
          if (_calcName.isNotEmpty) ...[
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                label: Text(_getContent('text.element_1', 'BERECHNUNG SPEICHERN')), style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
            ...
            child: Column(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(_getContent('text.element_2', 'DATUM ÄNDERN'))),
                ),
              ],
            ),
          ),
          ...
          if (_profile != null)
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_getContent('text.element_10', 'MEIN GEMATRIA TEILEN'))),
                style: ElevatedButton.styleFrom(
            ...
            child: Column(
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  label: Text(_getContent('text.element_12', 'ALS BILD EXPORTIEREN'))),
